...
const resources = {
  "pt-BR": {
    translation: {
      ...
      historyScopeGlobal: "Tudo",
      historyScopeRepo: "Repositório",
      historyScopeCwd: "Esta pasta",
      historyScopeSession: "Esta sessão",
      historyOnlyFailed: "Só falhas",
      historyOnlySlow: "Demorados",
      historyLastDay: "24h",
      ...
      statsTitle: "Estatísticas de agentes",
      statsHint:
        "Como os agentes se comportaram e quanto custaram de atenção humana. Só leitura — nada aqui executa, re-roda ou apaga.",
      statsRefresh: "Atualizar",
      statsPeriod7: "7 dias",
      statsPeriod30: "30 dias",
      statsPeriodAll: "Tudo",
      statsAllRepos: "Todos os repos",
      statsRequested: "Aprovações pedidas",
      statsAuto: "Auto-aprovadas",
      statsAutoHint: "Risco verde, ou já liberado antes nesta sessão.",
      statsHuman: "Decididas por humano",
      statsHumanHint: "Alguém teve que parar e olhar.",
      statsDenied: "Negadas",
      statsMedian: "Tempo mediano até decidir",
      statsMedianHint:
        "Mediana, não média: uma aprovação esquecida por horas não desloca o número.",
      statsCommandsTitle: "Comandos mais pedidos pelo agente",
      statsColCommand: "Comando",
      statsColRequests: "Pedidos",
      statsColRisk: "Risco",
      statsColApprovalRate: "Aprovação",
      statsNoCommands: "Nenhum pedido de aprovação no período.",
      statsSessionsTitle: "Sessões de agente",
      statsColSession: "Sessão",
      statsColCommandsRun: "Comandos",
      statsColApprovals: "Aprovações",
      statsColTotalTime: "Tempo total",
      statsNoSessions: "Nenhuma sessão de agente com atividade no período.",
      statsEmpty: "Nada registrado no período.",
      statsEmptyHint:
        "As estatísticas saem do histórico de aprovações e dos comandos executados. Rode um agente e volte aqui.",
      statsLoadError: "Não foi possível ler as estatísticas.",
      ...
      notifyRequest: "Avisar quando um agente precisar de você",
      notifyRequestHint:
      ...
      agentsBoardWaiting_other: "{{count}} esperando por você",
      agentsBoardGoToNext: "Ir para o próximo",
      agentsBoardObserved: "Detectados na tela",
      agentsBoardNoGate: "sem gate",
      agentsBoardNoSignal: "sem sinal",
      nextAttentionSessionNav: "Próximo agente esperando",
  ...
  en: {
    translation: {
      ...
      historyScopeGlobal: "All",
      historyScopeRepo: "Repository",
      historyScopeCwd: "This folder",
      historyScopeSession: "This session",
      historyOnlyFailed: "Failed only",
      historyOnlySlow: "Slow",
      historyLastDay: "24h",
      ...
      statsTitle: "Agent stats",
      statsHint:
        "How the agents behaved and how much human attention they cost. Read-only — nothing here runs, re-runs or deletes.",
      statsRefresh: "Refresh",
      statsPeriod7: "7 days",
      statsPeriod30: "30 days",
      statsPeriodAll: "All time",
      statsAllRepos: "All repositories",
      statsRequested: "Approvals requested",
      statsAuto: "Auto-approved",
      statsAutoHint: "Green risk, or already allowed earlier in this session.",
      statsHuman: "Decided by a human",
      statsHumanHint: "Someone had to stop and look.",
      statsDenied: "Denied",
      statsMedian: "Median time to decide",
      statsMedianHint:
        "Median, not average: one approval forgotten for hours doesn't move it.",
      statsCommandsTitle: "Commands the agent asked for most",
      statsColCommand: "Command",
      statsColRequests: "Requests",
      statsColRisk: "Risk",
      statsColApprovalRate: "Approval",
      statsNoCommands: "No approval requests in this period.",
      statsSessionsTitle: "Agent sessions",
      statsColSession: "Session",
      statsColCommandsRun: "Commands",
      statsColApprovals: "Approvals",
      statsColTotalTime: "Total time",
      statsNoSessions: "No agent session with activity in this period.",
      statsEmpty: "Nothing recorded in this period.",
      statsEmptyHint:
        "Stats come from the approval history and the commands that ran. Run an agent and come back.",
      statsLoadError: "Couldn't read the stats.",
      ...
      notifyRequest: "Notify when an agent needs you",
      notifyRequestHint:
      ...
      agentsBoardWaiting_other: "{{count}} waiting on you",
      agentsBoardGoToNext: "Go to next",
      agentsBoardObserved: "Detected on screen",
      agentsBoardNoGate: "no gate",
      agentsBoardNoSignal: "no signal",
      nextAttentionSessionNav: "Next agent waiting",
