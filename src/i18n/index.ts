...
const resources = {
  "pt-BR": {
    translation: {
      ...
      commandLineWaiting: "Esperando o shell terminar de carregar…",
      commandLineRunning: "Comando em execução — o teclado está no terminal.",
      commandLineOff: "Linha do TYBA desligada — ⌘⇧L liga de volta.",
      commandLineApp: "Um app está usando a tela — o teclado está no terminal.",
      commandLinePlaceholder: "Digite um comando… Enter executa, → aceita a sugestão.",
  ...
  en: {
    translation: {
      ...
      commandLineWaiting: "Waiting for the shell to finish loading…",
      commandLineRunning: "Command running — the keyboard is in the terminal.",
      commandLineOff: "TYBA line is off — ⌘⇧L turns it back on.",
      commandLineApp: "An app is using the screen — the keyboard is in the terminal.",
      commandLinePlaceholder: "Type a command… Enter runs it, → accepts the suggestion.",
