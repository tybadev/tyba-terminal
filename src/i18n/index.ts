...
const resources = {
  "pt-BR": {
    translation: {
      ...
      generalHint: "Padrões do TYBA para novas sessões.",
      codeHint: "Ajustes do terminal para o dia a dia de dev.",
  ...
  en: {
    translation: {
      ...
      generalHint: "TYBA defaults for new sessions.",
      codeHint: "Terminal tweaks for everyday dev work.",
