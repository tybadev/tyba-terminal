...
Cada ítem muestra el riesgo, el comando, la sesión y la carpeta — y hacer clic en la fila de la sesión te lleva hasta ella. Los botones son los mismos del toast y de la cola de agentes: *Approve*, *Always allow* cuando el riesgo lo permite, *Deny*, y *No, and tell it what to do*, que abre un campo para decirle al agente qué hacer en su lugar. La decisión es la misma, la tomes donde la tomes.

Con el inbox abierto, los toasts de las aprobaciones que muestra salen de la pantalla: cada pedido queda **en un solo lugar** para que actúes.
