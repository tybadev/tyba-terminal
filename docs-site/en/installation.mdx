---
title: "Installation"
description: "macOS, Linux and Windows — and the two prerequisites that don't come in the box."
---

The binaries for the current version are on [Releases](https://github.com/tybadev/tyba-terminal/releases).
