...
description: "Open-source terminal to let many AI agents work loose without losing control — each isolated in the OS, and nothing ships without your approval."
---
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/en/installation">
    macOS, Linux and Windows — plus the two things you install yourself: an agent and a git repo.
  </Card>
...
It describes what runs today, in **{VERSION}**. What doesn't exist yet doesn't show up here as if it did — same rule as the site: nothing here is a promise.
