...
<Note>
**It ships off.** Turn it on in **Settings → Code → TYBA command line**, on the *Use the TYBA line* switch. It applies to **new** sessions — the mode is set when the shell is born.
</Note>
