...
Cada item mostra o risco, o comando, a sessão e a pasta — e clicar na linha da sessão te leva até ela. Os botões são os mesmos do toast e da fila de agentes: *Aprovar*, *Sempre permitir* quando o risco deixa, *Recusar*, e *Não, e dizer o que fazer*, que abre um campo para você mandar ao agente o que ele deve fazer no lugar. A decisão é a mesma venha de onde vier.

Com o inbox aberto, os toasts das aprovações que ele mostra saem da tela: cada pedido fica **num lugar só** para você agir.
