...
<Note>
O TYBA prefere dado estruturado a adivinhação: o Claude Code roda com `--output-format stream-json`, então uma ferramenta pendente vira evento JSON em vez de texto raspado da tela. Sem isso, ele cai para integração de shell via OSC 133 e uma heurística de silêncio.
</Note>
